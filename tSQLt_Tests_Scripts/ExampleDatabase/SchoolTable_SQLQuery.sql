...
--CREATE PROCEDURE dbo.GetAllOnlineAndOnsiteCourse
--    AS
--        SELECT * FROM dbo.OnlineCourse
--        SELECT * FROM dbo.OnsiteCourse
--GO

--ALTER TABLE dbo.CourseInstructor ADD Evaluation TINYINT NULL;
--GO

--UPDATE dbo.CourseInstructor
--SET Evaluation = 1;

--ALTER TABLE dbo.Department ADD Location VARCHAR(20) NULL;
--GO
